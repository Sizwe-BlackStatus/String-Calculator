...
describe("string calculator", function () {
  ...
  it("should throw an invalid input error if last character in the string is not a digit", function () {
    expect(function () {
      add("//;\n1000,1;2;");
    }).toThrow(new Error("ERROR: invalid input"));
  });
  it("should throw an invalid input error if there is a space in the string", function () {
    expect(function () {
      add("  //;\n1000,1;2;");
    }).toThrow(new Error("ERROR: invalid input"));
  });
  it("should throw an invalid input error if there is a digit before //", function () {
    expect(function () {
      add("1,2,3//;\n1000,1;2;");
    }).toThrow(new Error("ERROR: invalid input"));
  });
